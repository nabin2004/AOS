...
|----------|---------|-------------|
| `PROJECT_NAME` | `aos` | Display name for the project |
...
| `LOGFIRE_SERVICE_NAME` | `aos` | Service name in Logfire dashboard |
...
| `S3_RAG_BUCKET` | `aos-rag` | Bucket name |
