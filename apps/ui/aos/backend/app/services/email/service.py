...
class EmailService:
    ...
    async def send_welcome(self, *, to: str, name: str, login_url: str) -> SendResult:
        return await self.send(
            ...
            to=to,
            context={"name": name, "login_url": login_url, "app_name": "aos"},
        )
    ...
    async def send_payment_failed(
        ...
        return await self.send(
            ...
            to=to,
            context={"name": name, "amount": amount, "update_url": update_url, "app_name": "aos"},
        )
    ...
    async def send_trial_expired(self, *, to: str, name: str, upgrade_url: str) -> SendResult:
        return await self.send(
            ...
            to=to,
            context={"name": name, "upgrade_url": upgrade_url, "app_name": "aos"},
        )
    ...
    async def send_low_credits(
        ...
        return await self.send(
            ...
            to=to,
            context={"name": name, "balance": balance, "topup_url": topup_url, "app_name": "aos"},
        )
    ...
    async def send_newsletter_welcome(
        ...
        return await self.send(
            ...
            to=to,
            context={"name": name, "unsubscribe_url": unsubscribe_url, "app_name": "aos"},
        )
