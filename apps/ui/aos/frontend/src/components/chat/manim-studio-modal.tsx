            ...
            <div className="space-y-4 max-w-4xl mx-auto">
              <div className="flex items-center justify-between pb-2 border-b border-border/40">
                <div>
                  <h3 className="text-base font-semibold text-foreground flex items-center gap-2">
                    ...
                    Manim Composer Visual Plan (scenes.md)
                  </h3>
                  <p className="text-xs text-muted-foreground">
                    Structured pedagogical arc with scenes, LaTeX formulas, visual elements, and camera transitions.
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <Button
                  ...
                  >
                    ...
                    {isEditingPlan ? "Preview Markdown" : "Edit Plan"}
                  </Button>
                  <Button
                    variant="ghost"
                    size="sm"
              ...
              <div className="flex items-center justify-between pt-4 border-t border-border/40">
                <div className="text-xs text-muted-foreground">
                  Review the plan above. You can freely edit scenes or proceed to synthesize Python code.
                </div>
                <Button
                  ...
                  <div className="space-y-3 py-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground font-mono">
                        {renderProgressMsg || "Processing LaTeX equations and rendering frames via Docker…"}
                      </p>
                    </div>
