...
const ContentSecurityPolicy = `
  ...
  font-src 'self' data:;
  connect-src 'self' ws: wss: http://localhost:* https://localhost:* https://*.modal.run wss://*.modal.run https://*.modal.direct wss://*.modal.direct https://*.r2.cloudflarestorage.com https://*.r2.dev;
  media-src 'self' blob: data: https://*.r2.dev https://*.r2.cloudflarestorage.com https://*.modal.run https://*.modal.direct;
  ${_frameAncestors}
  base-uri 'self';
  form-action 'self';
`
