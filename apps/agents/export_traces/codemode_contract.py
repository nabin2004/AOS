"""Detect CodeMode star-import violations in run_code tool payloads."""
...
def tool_trace_violates_codemode(row: dict[str, Any]) -> list[str]:
    """Return error codes when any run_code call violates the CodeMode contract."""
    return codemode_message_violations(row.get("messages"))
