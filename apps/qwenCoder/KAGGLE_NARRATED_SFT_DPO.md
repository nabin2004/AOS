...
|---|---|---|
| **Raw Agent Trajectories** | [`nabin2004/AOS-Trajectories`](https://huggingface.co/datasets/nabin2004/AOS-Trajectories) | 374 authentic code-agent trajectories across diverse math, physics, ML, and CS concepts |
| **Continued SFT Dataset** | [`nabin2004/AOS-Narrated-Manim-400`](https://huggingface.co/datasets/nabin2004/AOS-Narrated-Manim-400) | Cleaned `VoiceoverScene` scripts with `AOSSpeechService` in chat messages format |
| **DPO Preference Pairs** | [`nabin2004/manim-narrated-dpo-400`](https://huggingface.co/datasets/nabin2004/manim-narrated-dpo-400) | 361 aligned preference pairs (`chosen` = VoiceoverScene with synchronized narration, `rejected` = silent Scene generated via AST transformation) |
